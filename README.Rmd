...
If you want to install the development version then use `remotes` package to access
to the **GitHub**. If you haven't installed it before, the package will be
installed automatically prior to installing `norgeo` if you run the code below.
